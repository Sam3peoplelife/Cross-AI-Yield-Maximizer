...
let AssetManager = (_dec = NearBindgen({}), _dec2 = call({}), _dec3 = call({}), _dec4 = call({}), _dec5 = view(), _dec(_class = (_class2 = class AssetManager {
  // In AssetManager contract
  static proposals = [];
  static getUserProposals({
    user_id
  }) {
    // Return a list of proposals for the given user
    return AssetManager.proposals.filter(proposal => proposal.user_id === user_id);
  }
  static confirmAllocation({
    user_id,
    proposalId
  }) {
...
}, _applyDecoratedDescriptor(_class2.prototype, "proposeAllocation", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "proposeAllocation"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "confirmAllocation", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "confirmAllocation"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "rejectAllocation", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "rejectAllocation"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getUserProposals", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "getUserProposals"), _class2.prototype), _class2)) || _class);
function getUserProposals() {
  const _state = AssetManager._getState();
  if (!_state && AssetManager._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = AssetManager._create();
  if (_state) {
    AssetManager._reconstruct(_contract, _state);
  }
  const _args = AssetManager._getArgs();
  const _result = _contract.getUserProposals(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AssetManager._serialize(_result, true));
}
function rejectAllocation() {
  ...
  const _args = AssetManager._getArgs();
  const _result = _contract.rejectAllocation(_args);
  AssetManager._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AssetManager._serialize(_result, true));
}
function confirmAllocation() {
  ...
  const _args = AssetManager._getArgs();
  const _result = _contract.confirmAllocation(_args);
  AssetManager._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AssetManager._serialize(_result, true));
}
function proposeAllocation() {
  ...
  const _args = AssetManager._getArgs();
  const _result = _contract.proposeAllocation(_args);
  AssetManager._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(AssetManager._serialize(_result, true));
}
let ProposalStatus = /*#__PURE__*/function (ProposalStatus) {
...
export { ProposalStatus, confirmAllocation, getUserProposals, proposeAllocation, rejectAllocation };
